        ...
        <div class="mm2">
            ...
            <div class="container text-center">
                <div class="row justify-content-md-center">
                    ...
                    @if (!empty($data->contacts->linkedin))
                    ...
                    @if (!empty($data->contacts->instagram))
                        <div class="col-md-6 col-xl-4 aos-init aos-animate mb-3">
                            <a href="{{ $data->contacts->instagram }}" target="_blank"
                    ...
                    <div class="col-sm-4">
                        <ul class="list-unstyled text-white pt-2 mb-0">
                            <li class="py-1 d-flex align-items-center">
                                <a href="mailto:{{ $data->contacts->email }}" target="_blank" rel="noreferrer"
